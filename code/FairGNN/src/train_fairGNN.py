...
parser.add_argument('--reproducibility', type=int, default=0,
                    help="use poisoned dataset")
...
if args.reproducibility == 0:
	...
	glist, _ = dgl.load_graphs(f'../dataset/{args.dataset}.bin')  # load poisoned graph file
	g = glist[0]
