...
gat-attention-heads: setup
	...
	@python code/main.py --seed 42 --n_times 3 --dataset pokec_z --alpha 0.01 --beta 4 --node 102 --edge 50 --device $(DEVICE) --models 'GAT' --att_heads 16 --output_path $(OUT_DIR)/gat_attention_heads_5.csv
	@python code/main.py --seed 42 --n_times 3 --dataset pokec_z --alpha 0.01 --beta 4 --node 102 --edge 50 --device $(DEVICE) --models 'GAT' --att_heads 32 --output_path $(OUT_DIR)/gat_attention_heads_6.csv
