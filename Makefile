...
nifa: setup
	@python code/main.py --seed=42 --dataset pokec_z --alpha 0.01 --beta 4 --node 102 --edge 50 --before --device $(DEVICE) --mode 'degree' --output_path $(OUT_DIR)/nifa_pokec_z.csv --models 'GCN' 'GraphSAGE' 'APPNP' 'SGC' #'FairGNN' 'FairVGNN' 'FairSIN'

	@python code/main.py --seed=42 --dataset pokec_n --alpha 0.01 --beta 4 --node 87 --edge 50 --before --device $(DEVICE) --mode 'degree' --output_path $(OUT_DIR)/nifa_pokec_n.csv --models 'GCN' 'GraphSAGE' 'APPNP' 'SGC' #'FairGNN' 'FairVGNN' 'FairSIN'

	@python code/main.py --seed=42 --dataset dblp --alpha 0.1 --beta 8 --node 32 --edge 24 --epochs 500 --before --device $(DEVICE) --mode 'degree' --output_path $(OUT_DIR)/nifa_dblp.csv --models 'GCN' 'GraphSAGE' 'APPNP' 'SGC' #'FairGNN' 'FairVGNN' 'FairSIN'
